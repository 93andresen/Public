...
>> %RegFile% Echo.
>> %RegFile% Echo [HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Themes\Personalize]
>> %RegFile% Echo "EnableTransparency"=dword:00000001
