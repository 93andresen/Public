...
#Download the file
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/93andresen/Richard_Public/main/ahk_script_test_delete.ahk' -OutFile 'c:\zzz_temp\ahk_script_test_delete.ahk'
